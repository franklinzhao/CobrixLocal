error id: com/example/spark/cobol/app/utils/ConfigUtils.getExtraOptions().
...
non-local guesses:
	 -com/example/spark/cobol/app/utils/ConfigUtils.getExtraOptions.
	 -com/example/spark/cobol/app/utils/ConfigUtils.getExtraOptions#
	 -com/example/spark/cobol/app/utils/ConfigUtils.getExtraOptions().
	 -ConfigUtils.getExtraOptions.
	 -ConfigUtils.getExtraOptions#
	 -ConfigUtils.getExtraOptions().
	 -scala/Predef.ConfigUtils.getExtraOptions.
	 -scala/Predef.ConfigUtils.getExtraOptions#
	 -scala/Predef.ConfigUtils.getExtraOptions().
