error id: com/example/spark/cobol/app/SparkCobolS3App.runMySparkApp().(spark)
...
found definition using semanticdb; symbol com/example/spark/cobol/app/SparkCobolS3App.runMySparkApp().(spark)
