error id: za/co/absa/cobrix/cobol/parser/antlr/ANTLRParser.parse().
file://<WORKSPACE>/cobol-parser/src/main/scala/za/co/absa/cobrix/cobol/parser/CopybookParser.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol za/co/absa/cobrix/cobol/parser/antlr/ANTLRParser.parse().
