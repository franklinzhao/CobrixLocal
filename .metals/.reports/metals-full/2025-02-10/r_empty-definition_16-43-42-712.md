...
found definition using fallback; symbol CollapseRoot
Document text:
...
object RowExtractorTest{
  ...
  val inputData = "<WORKSPACE>/examples/example_data/raw_data/file1.bin"
...
""".stripMargin
  ...
  val schemaPolicy: SchemaRetentionPolicy = SchemaRetentionPolicy.CollapseRoot
