error id: za/co/absa/cobrix/cobol/parser/Copybook#getCobolSchema().
...
found definition using semanticdb; symbol za/co/absa/cobrix/cobol/parser/Copybook#getCobolSchema().
...
""".stripMargin
  ...
  println("copybook ast:::"+copybook.ast)
  ...
  def main(args: Array[String]): Unit = {
    ...
    // id
    println(innerRow.head.asInstanceOf[Int])
